        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          <div v-on:click="triggerMediaInput" class="cursor-pointer">
            ...
            <div
              ...
              <input type="file" :accept="getMediaAcceptType()" v-on:change="onMediaChange" class="hidden"
                ref="mediaInput" />

              <!-- Media Preview -->
              <div v-if="mediaPreview"
                class="w-full h-full rounded-lg overflow-hidden flex items-center justify-center bg-black">
                <video v-if="form.media_type === 'video'" :src="mediaPreview" controls
                  class="max-h-64 w-full object-contain"></video>
                <audio v-else-if="form.media_type === 'audio'" :src="mediaPreview" controls
                  class="w-full max-w-sm p-4"></audio>
                <img v-else-if="form.media_type === 'image'" :src="mediaPreview"
              ...
              <div v-else class="text-center p-4">
                <svg class="mx-auto h-12 w-12 text-indigo-400 group-hover:text-indigo-600 transition" fill="none"
                  viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                </svg>
                <p class="mt-2 text-sm font-medium text-gray-600">Click to select {{ form.media_type || 'media' }} file
                </p>
          ...
          <div v-on:click="triggerThumbnailInput" class="cursor-pointer">
            ...
            <div
              ...
              <input type="file" accept="image/*" v-on:change="onThumbnailChange" class="hidden" ref="thumbnailInput" />
