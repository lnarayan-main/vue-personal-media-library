    ...
    <div v-else class="flex flex-col lg:flex-row gap-2">
      ...
      <div class="flex-1">
        ...
        <div v-if="media.media_type === 'video'"
          class="w-full rounded-xl overflow-hidden bg-black shadow-md flex items-center justify-center">
          ...
          <VideoPlayer :hls_path="media.hls_path" :thumbnail_url="getFileUrl(media.thumbnail_url)" :media="media" />

        </div>
        <div v-else-if="media.media_type === 'audio'"
          class="w-full rounded-xl overflow-hidden bg-black shadow-md flex items-center justify-center aspect-video">
